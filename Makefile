...
DHDCFLAGS = -Wall -Wstrict-prototypes -Wno-date-time                      \
	...
	-DMULTIPLE_SUPPLICANT -DTSQ_MULTIPLIER=10 -DMFP -DDHD_8021X_DUMP      \
...
DHDOFILES = aiutils.o siutils.o sbutils.o hndpmu.o hndjtag.o              \
...
DHDCFLAGS += -DBCMSDIO -DMMC_SDIO_ABORT -DUSE_SDIOFIFO_IOVAR -DBCMLXSDMMC \
	...
	-DSTATIC_MEM_BUF -DBCMSDIO_INTSTATUS_WAR
...
#	DHDCFLAGS += -DRMMOD_POWER_DOWN_LATER -DPCIE_ATU_FIXUP
#	DHDCFLAGS += -DDEVICE_PM_CALLBACK
